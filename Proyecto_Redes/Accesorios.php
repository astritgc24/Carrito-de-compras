...
<nav class="navbar navbar-expand-lg navbar-dark">
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ml-auto">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="Lociones.php">Locioness</a>
                    </li>
                    <li class="nav-item">
    ...
    <div class="container">
        ...
        <?php 
            ...
            $consulta = "SELECT * FROM producto WHERE producto.id_categoria = '3'";
    ...
    <script src="https://stackpath.bootstrapcdn.com/bootstrap/5.3.3/js/bootstrap.bundle.min.js" integrity="sha384-XXXXXX" crossorigin="anonymous"></script>
</body>
</html>
